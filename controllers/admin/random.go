...
func (rc RandomController) Index(c *gin.Context) {
	...
	c.HTML(200, "admin/random/index", gin.H{
		"Randoms": randoms,
	})
}
...
func (rc RandomController) Show(c *gin.Context) {
	...
	c.HTML(200, "admin/random/edit", gin.H{
		"Random": random,
	})
}
...
func (rc RandomController) Update(c *gin.Context) {
	...
	c.Redirect(302, fmt.Sprintf("/admin/random/%d", updated.ID))
}
...
func (rc RandomController) Create(c *gin.Context) {
	...
	c.Redirect(302, fmt.Sprintf("/admin/random/%d", created.ID))
}
